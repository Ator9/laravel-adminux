    ...
    <div class="card mt-3">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <div>
                    <a href="{{ str_replace('/edit', '', Request::url()) }}"><span data-feather="arrow-left" class="feather-adminux2 me-2 mt-1"></span></a>
                    <h5 class="d-inline">{{ __('adminux.edit') }} {{(new ReflectionClass($model))->getShortName()}}</h5>
                </div>
                <div>
